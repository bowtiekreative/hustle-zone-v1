...
> Black RSS Feeds Aggregator — Stay on top of Black news, hip hop, celebrity gossip, entertainment, and culture.
...
| **Neo Soul** | 4+ | A&R Factory, Sounds So Beautiful, Stamp The Wax |
| **Reggae & Dancehall** | 15+ | World A Reggae, YARDHYPE, DancehallMag, Urban Islandz |
| **African Music** | 10+ | SA Hip Hop Mag, NotJustOk, Ghana Music, NaijaVibes |
| **Afrobeat** | 5+ | NotJustOk, Africanmusic.com, Boomplay |
| **UK Hip Hop** | 5+ | Urban Vault UK, Wordplay, Mic Cheque |
| **Caribbean** | 5+ | MISS GAZA, LargeUp, Urban Islandz |
| **Hollywood & Industry** | 10+ | Hollywood Reporter, Variety, Deadline, TheWrap |
...
| **Sports** | 5+ | HBCU Sports, Andscape |
| **Lifestyle+Faith** | 5+ | Essence, MadameNoire, Girls United |

## 🚀 How To Use These Feeds

1. **RSS Reader** — Import the CSV into any RSS reader (Feedly, Inoreader, Feeder.co, etc.)
2. **Automation** — Use Zapier/Make to auto-post new feed items to social media
3. **Website** — Power a blog/news aggregator site with these feeds
4. **Telegram/Discord Bot** — Forward breaking news to a channel

## 📝 Notes

- RSS feeds with no URL listed may require verification or use different publishing methods
- Some sites (The Shade Room, Hollywood Unlocked) are primarily Instagram-based but have secondary RSS feeds
- Feeds are verified as of June 2026 — some may change over time
